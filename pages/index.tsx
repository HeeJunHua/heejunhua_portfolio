  ...
  return (
    <Layout>
      ...
      <PageWrapper>
        <article>
          <motion.h1
            data-text="I'm Hee Jun Hua"
            className="intro__text"
            {...getTransitions(0.1)}
          >
            <mark className="mark">I&apos;m Hee Jun Hua</mark>
          </motion.h1>
          <motion.p {...getTransitions(0.3)}>
            A passionate full-stack developer and programming enthusiast. I specialize in building dynamic and user-friendly web applications, integrating intuitive user interfaces with robust backend systems. My expertise spans across technologies like React, Node.js, and various other modern frameworks and tools.
          </motion.p>
          <motion.p {...getTransitions(0.5)}>
            I thrive on creating seamless digital experiences. Beyond coding, I enjoy exploring innovative solutions, continuously improving my skills, and collaborating with others to turn ideas into reality. Learn more about my journey by visiting the{' '}
          ...
          <motion.p {...getTransitions(0.7)}>
            When I’m not coding, you’ll find me reading technical blogs, experimenting with new frameworks, or enjoying good music. Feel free to{' '}
            <Link href="/contact" aria-label="Go to Contact Page">
              Contact Me
            </Link>{' '}to discuss potential opportunities or collaborations.
          </motion.p>
          <motion.p {...getTransitions(0.8)}>
            I have also included my <Link href="/resume" aria-label="View my Resume">Resume</Link> for more detailed information about my professional background and skills.
          </motion.p>
        </article>
        <br />
